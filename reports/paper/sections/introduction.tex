...
We (i) show the 2022 collapse is a structural covariate shift rather than a level
change; (ii) locate an accuracy ceiling and diagnose it as a feature ceiling that
becomes a genuine data ceiling once school socioeconomic composition is added;
(iii) characterise the crisis as broad-based and shared with regional peers; and
(iv) connect these statistical findings to Albania's economic and structural context,
while delivering a calibrated, interpretable, and honestly-bounded risk screener that
we argue should not be read causally.
