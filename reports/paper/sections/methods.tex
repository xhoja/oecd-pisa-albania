...
Logic lives in unit-tested modules ($>$130 tests on synthetic fixtures, covering the
weighted statistics, Rubin's rules, the leakage-safe transformer, the BRR+PV variance,
and the Nadeau--Bengio / DeLong maths); notebooks are narrative layers over them. On
