...
rate. A fixed-versus-malleable bundle contrast sizes how far actionable levers reach
before the structural floor. Like the policy simulations these are model-associational
contrasts, not causal effects.

\subsection{Reproducibility and engineering}
Logic lives in unit-tested modules (188 tests on synthetic fixtures, covering the
